...
void BB_GameScene::initGameLayer()
{
	...
	m_pScoreLabel->setAnchorPoint(Vec2::ANCHOR_MIDDLE_TOP);
	m_pScoreLabel->setPosition(_contentSize.width * 0.5f, _contentSize.height - fLenght);
	...
	m_pBombNumLabel->setAnchorPoint(Vec2::ANCHOR_BOTTOM_LEFT);
	m_pBombNumLabel->setPosition(fLenght, fLenght * 4);
