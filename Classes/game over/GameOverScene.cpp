...
bool GameOverScene::init()
{
	...
	do 
	{
		...
		auto AgainStartMenu = MenuItemLabel::create(AgainStartLabel,this, menu_selector(GameOverScene::MenuStartCallBack));
		auto MenuAgain = Menu::create(AgainStartMenu, NULL);
		MenuAgain->setPosition(Vec2(AgainStartMenu->getContentSize().width * 0.5f, AgainStartMenu->getContentSize().height * 0.5f));
